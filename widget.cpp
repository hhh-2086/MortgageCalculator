...
{  
   ...
   connect(ui->clearButton,p2,[=](){
    ...
    ui->lineEdit->setValidator(new QDoubleValidator(0,9.99,2,this));
    ui->lineEdit_5->setMaxLength(4);
    ui->lineEdit_5->setValidator(new QDoubleValidator(0,9.99,2,this));
    ui->lineEdit_7->setMaxLength(4);
    ui->lineEdit_7->setValidator(new QDoubleValidator(0,9.99,2,this));
